...
#SBATCH --job-name=reactionDiffusionSimulations2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Run Matlab program
matlab -batch "rdsim2(${points},${physical_runtime},${nRuns},${tcorr_start},${tcorr_end},${tcorr_points},${tv_start},${tv_end},${tv_points},${numWorkers},${dt},${A}); exit;"
